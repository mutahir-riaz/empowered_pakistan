...
export async function GET(_req, { params }) {
  try {
    ...
    const doc = await Opportunities.findById(id).lean();
...
export async function PATCH(req, { params }) {
  try {
    ...
    const updated = await Opportunities.findByIdAndUpdate(id, data, {
...
export async function DELETE(req, { params }) {
  try {
    ...
    const { id } = await params; 
    const deleted = await Opportunities.findByIdAndDelete(id);
