          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                size="lg"
                className="bg-ourDarkBlue hover:bg-ourDarkBlue/90 text-white px-8 py-4 rounded-full shadow-lg transition-all duration-300 hover:shadow-xl flex items-center gap-2"
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-2 border-ourDarkBlue text-ourDarkBlue hover:bg-ourDarkBlue hover:text-white px-8 py-4 rounded-full transition-all duration-300"
              >
